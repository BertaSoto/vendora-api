...
export function ProductCard({
  ...
  return (
    <div className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:shadow-md hover:border-slate-300">
      <div className="flex items-start justify-between gap-2">
        <h3 className="text-base font-semibold text-slate-900">{product.name}</h3>
        <span className="shrink-0 text-lg font-bold text-brand-600 tabular-nums">
      ...
      {product.description ? (
        ...
        <p className="mt-1.5 text-sm text-slate-300 italic">Sin descripción</p>
      )}
